...
const AddRoomClass = () => {
  ...
  const onSubmit = async (e) => {
    ...
    if (!form.className || !form.basePrice || !form.description) {
    ...
    try {
      ...
      formData.append("occupancy", form.occupancy);
  ...
  <div className="bg-white rounded-3xl shadow-2xl w-[1130px]  overflow-hidden">
    ...
    <div className="p-10">
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-2 gap-8">
          <div className="bg-gray-50 rounded-lg p-6 shadow-sm hover:shadow-md transition-all duration-300">
            <h3 className="text-sm font-semibold text-gray-700 mb-2">Occupancy</h3>
            <input
              type="text"
